...
export const LINK = {
  ...
  DISTRIBUTION: {
    precisionGroupPasses: ["precisionGroupPasses"],
    precisionGroupSmartPasses: ["precisionGroupSmartPasses"],
    precisionGroupThroughPasses: ["precisionGroupThroughPasses"],
    precisionGroupLongPasses: ["precisionGroupLongPasses"],
    precisionGroupForwardPasses: ["precisionGroupForwardPasses"],
    precisionGroupCrosses: ["precisionGroupCrosses"],
  },
  CREATION: {
    assists: ["assists"],
    shotAssists: ["shotAssists"],
    precisionGroupKeyPasses: ["precisionGroupKeyPasses"],
  },
  DUELS: {
  ...
  PERCUSSION: {
    precisionGroupDribbles2: ["precisionGroupDribbles2"],
...
export const TRANSLATION: any = {
  ...
  precisionGroupPasses: "PARTICIPATION AU JEU",
  precisionGroupCrosses: "CENTRES",
  precisionGroupSmartPasses: "PASSES CREATIVES & TECHNIQUES",
  precisionGroupThroughPasses: "PASSES EN PROFONDEURS",
  precisionGroupLongPasses: "PASSES LONGUES",
  precisionGroupForwardPasses: "RATIO DE PASSES EN AVANT",
  CREATION: "CREATION",
  assists: "PASSES DECISIVES",
  shotAssists: "PASSES DECISIVES",
  precisionGroupKeyPasses: "PASSES CLEFS",
  DUELS: "DUELS",
  groupAerialDuels: "DUELS AERIENS",
  precisionGroupDefensiveDuels: "DUELS DEFENSIFS",
  precisionGroupDribbles: "DRIBBLES",
  groupDribblesAgainst: "DRIBBLES ADVERSES",
  groupLooseBallDuels: "CONQUETE DU BALLON",
  precisionGroupOffensiveDuels: "DUELS OFFENSIFS",
  precisionGroupSlidingTackles: "TACLES GLISSES",
  ...
  precisionGroupDribbles2: "DRIBBLES",
  accelerations: "ACCELERATIONS",
...
export const POSITIONS = {
  ...
  MILIEUXOFFENSIF: ["amf"],
  AILLIERSRIGHT: ["rw", "ramf"],
  AILLIERSLEFT: ["lw", "lamf"],
  ATTAQUANTS: ["cf", "ss"],
  ATTAQUANTSLEFT: ["lwf"],
  ATTAQUANTSRIGHT: ["rwf"],
};
